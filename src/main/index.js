...
function createTouchBarButton() {
  ...
  let touchBar = new TouchBar({
    items: [button1, new TouchBarSpacer({ size: "small" }), button2, new TouchBarSpacer({ size: "small" }), button3, new TouchBarSpacer({ size: "small" })],
  });
...
const soURL = process.env.NODE_ENV === "development" ? `http://localhost:9080/#/so` : `file://${__dirname}/index.html#so`;

const settingURL = process.env.NODE_ENV === "development" ? `http://localhost:9080/#/setting` : `file://${__dirname}/index.html#setting`;

const desktopURL = process.env.NODE_ENV === "development" ? `http://localhost:9080/#/desktop` : `file://${__dirname}/index.html#desktop`;

const webURL = process.env.NODE_ENV === "development" ? `http://localhost:9080/#/web` : `file://${__dirname}/index.html#web`;

const videoURL = process.env.NODE_ENV === "development" ? `http://localhost:9080/#/video` : `file://${__dirname}/index.html#video`;

const pdfURL = process.env.NODE_ENV === "development" ? `http://localhost:9080/#/pdf` : `file://${__dirname}/index.html#pdf`;
